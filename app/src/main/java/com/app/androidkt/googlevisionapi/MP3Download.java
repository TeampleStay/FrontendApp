...
public class MP3Download extends AppCompatActivity {
                    ...
                    builder.setPositiveButton("예",
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    final DownloadFilesTask downloadTask = new DownloadFilesTask(MP3Download.this);
    ...
    private void showDialogforPermission(String msg) {
        ...
        final AlertDialog.Builder myDialog = new AlertDialog.Builder(  MP3Download.this);
